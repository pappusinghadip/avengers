...
7. Never amend, force-push, delete branches, or publish without explicit approval.
...
After commit, ask whether to push. If approved, detect upstream and push safely.
