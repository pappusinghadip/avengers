...
- Never print or write secrets, tokens, `.env` values, private keys, credentials, session cookies, personal data, or customer data to output, logs, reports, memory, or `.avengers/.temp/` artifacts.
