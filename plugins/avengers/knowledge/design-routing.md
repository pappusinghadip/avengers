...
Use this for Spider-Man and Captain America on visual, UI, or design-system work.
Apply only when the task involves design, look-and-feel, layout, or visual QA.

## Principle

Avengers builds and verifies; it does not invent a visual system from scratch when a
...
3. If a matching skill is installed, invoke it (Spider-Man via the Skill tool; Captain
